  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="form-area">
          <div class="form-sing">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active form-are" >
        ...
        <div class="form-input-group " >
    <label for="HowtoknowSelect" >如何知道補習班:</label>
    <select class="form-control" id="HowtoknowSelect" name="HowtoknowSource" required onchange="updateLabel(this.value)" >
...
<script>
    function updateLabel(value) {
        var inputField = document.querySelector('input[name="Howtoknow"]');
        inputField.value = value; // 根據選擇的值更新輸入框
    }
</script>
...
<!--<script>
    function updateLabel(value) {
        var label = document.querySelector('label[for="Howtoknow"]');
...
<script>
  function updateLabel(value) {
    var inputField = document.getElementById('HowtoknowInput');
    if (value === '補習班') {
        inputField.style.display = 'block';  // 或其他行為
    } else {
