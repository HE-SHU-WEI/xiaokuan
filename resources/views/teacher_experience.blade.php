...
<body>
	...
	<div class="row">
		<div class="col-12">
			<img src="photos/teacher/discourse.png">
    ...
    <div class="hero-area d-flex align-items-center">
        <!-- Hero Thumbnail -->
        <div class="hero-thumbnail equalize bg-img" style="background-image: url(photos/teacher/teacher1.png); background-size: 70%;"></div>
            ...
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-md-8">
						<h5 style="color: #b4b5b5">教師資歷</h5>
						<h5 style="color: #b4b5b5">好的老師帶你上好的學校</h5>
						<br>
                        <div class="line"></div>
                        <h2>莊小寬</h2>
						 <a href="#" class="btnteacher sonar-btn2">學歷</a>
                        <p>
							<br>• 建中43屆 / 北聯第二名錄取（71161）
                            <br>• 交大數學系（u8022017）
                            <br>• 交大數研所（u8422511）
                        </p>
                        <a href="#" class="btnteacher sonar-btn2">經歷</a>
						<p>
							<br>• 高雄捷勝補習班
                            <br>• 台南儒林補習班
                            <br>• 嘉義垂楊補習班
