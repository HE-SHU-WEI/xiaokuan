        ...
        <section class="section">
          <div class="section-header">
            <div class="section-header-back">
              <a href="{{ route('manager.index') }}" class="btn btn-icon">
          ...
          <div class="section-body">
            ...
            @endif
                    ...
                    <div class="form-group row mb-4">
                      <label  for="name" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">管理員姓名:</label>
                      <div class="col-sm-12 col-md-7">
                        <p class="form-control">{{ $manager->name }}</p>
                      </div>
                    </div>
					  
					  <!--account-->
                    <div class="form-group row mb-4">
                      <label  for="account" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">帳號:</label>
                      <div class="col-sm-12 col-md-7">
						            <p class="form-control">{{ $manager->account }}</p>
                      </div>
                    </div>
                ...
                <div class="card">
                  ...
                  <form action="{{ route('manager.updateManager') }}" method="POST">  
                    ...
                    <div class="form-group row mb-4">
                      <label  for="account" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">帳號:</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="account" class="form-control" name="account"  value="{{ $manager->account }}" required>
                      </div>
                    </div>
					  
					   <!-- password -->
                    <div class="form-group row mb-4">
                      <label  for="password" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">密碼:</label>
                      <div class="col-sm-12 col-md-7">
