            ...
            <div class="row">
                ...
                @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                     ...
                     <!-- introduce -->
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">   介紹</label>
                        <textarea class="summernote"  id="introduction" name="introduction" rows="3" placeholder="輸入介紹"></textarea>
                    </div>
              ...
              <input type="date" class="form-control" id="entry" name="entry">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <button type="submit" class="btn btn-primary">創建老師</button>
                      </div>
                    </div>
